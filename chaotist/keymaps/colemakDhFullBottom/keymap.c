...
[_BASE] = LAYOUT(
    ...
    MC_Z,           KC_NO,  MC_X,   MC_C,       MC_D,                KC_V,        KC_K,               MC_H,             MMC_COMMA,  MMC_DOT,        KC_NO,      MMC_QUOT,
    KC_LCTL,        KC_NO,  KC_LALT,MO(_SYSTEM),LSFT_T(KC_SPACE),    UNICORN,     KC_NO,              MC_NAV_CMD,       MO(_SYSTEM),KC_BSLS,       KC_NO,       KC_SLSH),
[_NUMSYM] = LAYOUT(
    KC_TAB,         KC_1,   KC_2,   KC_3,       KC_4,                KC_5,        KC_6,               KC_7,             KC_8,       KC_9,          KC_0,        KC_DEL,
    KC_NO,          MC_TILD,KC_AT,  MC_EQL_BKSL,MC_ASTR_PIP,         MC_PLUS_SLSH,KC_COLON,           KC_LPRN,          KC_LBRC,    KC_LCBR,       KC_LT,       KC_NO,
    KC_DLR,         KC_NO,  KC_PERC,MC_CARET,   KC_HASH,             KC_AMPR,     KC_SCLN,            KC_RPRN,          MC_SBR_COMMA,MC_CBR_DOT,   KC_NO,       KC_GT,
    KC_LCTL,        KC_NO,  KC_LALT,KC_NO,      LSFT_T(KC_SPACE),    UNICORN,     KC_NO,              MC_NAV_CMD,       KC_NO,      MC_TILD,       KC_NO,       KC_COLON),
[_NAVFN] = LAYOUT(
    ...
    KC_F11,         KC_NO,  KC_F12, LCTL(KC_C), LCTL(KC_X),          LCTL(KC_V),  LSFT(LCTL(KC_LEFT)),LCTL(KC_LEFT),    LSFT(KC_DOWN),LCTL(KC_RIGHT),KC_NO,     LSFT(LCTL(KC_RIGHT)),
    KC_LCTL,        KC_NO,  KC_LALT,KC_NO,      LSFT_T(KC_SPACE),    UNICORN,     KC_NO,              MC_NAV_CMD,       KC_NO,      KC_NO,         KC_NO,       KC_NO),
[_SYSTEM] = LAYOUT(
...
[_CMD] = LAYOUT(
    KC_NO,          KC_NO,  KC_ESC, LSFT(LCTL(KC_F)),LSFT(KC_TAB),    KC_NO,      KC_NO,              LSFT(KC_ENT),     RALT(KC_Y), KC_DEL,        KC_NO,       KC_NO,
    KC_NO,          RALT(KC_Q),KC_NO,RALT(KC_S),KC_TAB,               LGUI(LALT(KC_K)),KC_NO,         KC_ENT,           LALT(LCTL(KC_5)),KC_BSPC,  RALT(KC_P),  KC_NO,
    KC_NO,          KC_NO,  KC_NO,  KC_NO,      KC_NO,                KC_NO,      KC_NO,              KC_NO,            KC_NO,      DELWORD,       DELLINE,     KC_NO,
    KC_NO,          KC_NO,  KC_NO,  KC_NO,      KC_NO,                KC_NO,      KC_NO,              MC_ENC_SW,        KC_NO,      KC_NO,         KC_NO,       KC_NO)
};
