...
[_BASE] = LAYOUT(
    ...
    KC_LCTL,        KC_NO,  KC_LALT,MO(_SYSTEM),LSFT_T(KC_SPACE),    MC_LEAD,     KC_NO,              LT(_NAVFN,KC_ENT),MO(_SYSTEM),KC_BSLS,       KC_NO,       KC_SLSH),
[_NUMSYM] = LAYOUT(
    ...
    KC_LCTL,        KC_NO,  KC_LALT,KC_NO,      LSFT_T(KC_SPACE),    MC_LEAD,     KC_NO,              LT(_NAVFN,KC_ENT),KC_NO,      MC_TILD,       KC_NO,       KC_COLON),
[_NAVFN] = LAYOUT(
    ...
    KC_F11,         KC_NO,  KC_F12, LCTL(KC_C), LCTL(KC_X),          LCTL(KC_V),  LSFT(LCTL(KC_LEFT)),LCTL(KC_LEFT),    KC_NO,      LCTL(KC_RIGHT),KC_NO,       LSFT(LCTL(KC_RIGHT)),
    KC_LCTL,        KC_NO,  KC_LALT,KC_NO,      LSFT_T(KC_SPACE),    MC_LEAD,     KC_NO,              LT(_NAVFN,KC_ENT),KC_NO,      KC_NO,         KC_NO,       KC_NO),
[_SYSTEM] = LAYOUT(
