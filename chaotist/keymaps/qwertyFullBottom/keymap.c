 ...
 * │Shift      │     │     │     │     │     │     │     │     │           │
 * ├────────┬──┴──┬──┴──┬──┴─────┴──┬──┴──┬──┴─────┴──┬──┴──┬──┴──┬────────┤
 * │Esc     │- _  │funct│space      │move │     return│magic│\ |  │/ ?     │
 * │Ctrl    │Alt  │     │lower      │     │      raise│     │     │        │
 * └────────┴─────┴─────┴───────────┴─────┴───────────┴─────┴─────┴────────┘
 * lower
 * ┌─────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┐
...
[_QWERTY] = LAYOUT(
	...
	LCTL_T(KC_ESC),	KC_NO,	LALT_T(KC_MINUS),	MO(_FUNCTION),	LT(_LOWER,KC_SPACE),MO(_MOVE),	KC_NO,	LT(_RAISE,KC_ENT),	MO(_MAGIC),	KC_BSLS,KC_NO,	KC_SLSH),
[_LOWER] = LAYOUT(
...
[_RAISE] = LAYOUT(
	...
	LCTL_T(KC_ESC),	KC_NO,	LALT_T(KC_MINUS),	MO(_FUNCTION),	LT(_LOWER,KC_SPACE),MO(_MOVE),	KC_NO,		LT(_RAISE,KC_ENT),	MO(_MAGIC),	KC_BSLS,KC_NO,	KC_SLSH),
[_MOVE] = LAYOUT(
	LSFT_T(KC_TAB),	KC_NO,KC_NO,	KC_NO,				KC_NO,KC_NO,LCTL(KC_HOME),		KC_PGUP,		KC_UP,				KC_PGDN,		LCTL(KC_END),	KC_DEL,
...
[_FUNCTION] = LAYOUT(
	LSFT_T(KC_TAB),	KC_F1,KC_F2,	KC_F3,				KC_F4,  KC_F5,  KC_F6,	KC_NO,	KC_NO,				KC_NO,	KC_NO,	KC_DEL,
...
[_MAGIC] = LAYOUT(
	...
	LSFT(LGUI(KC_LEFT)),			KC_NO,				LALT(KC_F4),KC_NO,			KC_NO,		QK_BOOT,		KC_NO,		KC_NO,		KC_NO,		KC_NO,		KC_NO,		LSFT(LGUI(KC_RIGHT)))
};
