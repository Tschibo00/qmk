 ...
 * │     ├─────┤CtrlC│     │     │ ___ │     │     │SelLn├─────┤     │
 * ├─────┤F12  │     ├─────┼─────┤/U D\├─────┼─────┤     │WrdRg├─────┤
 * │F11  │     ├─────┤CtrlX│CtrlV│|L*R|│SelWL│WrdLf├─────┤     │SelWR│
 * │     ├─────┘     │     │     │\___/│     │     │     └─────┤     │
 * └─────┘           └─────┴─────┘     └─────┴─────┘           └─────┘
 *                         ┌─────┐     ┌─────┐
 *                         │space├─────┤cmd  │
 ...
 * │     ├─────┤CtrlC│     │Tab  │ ___ │     │     │     ├─────┤     │
 * ├─────┤CtrlY│     ├─────┼─────┤/U D\├─────┼─────┤     │     ├─────┤
 * │CtrlZ│     ├─────┤CtrlX│CtrlV│|L*R|│Alt  │Shift├─────┤     │""   │
 * │     ├─────┘     │     │     │\___/│CtrlV│CtrlV│     └─────┤     │
 * └─────┘           └─────┴─────┘     └─────┴─────┘           └─────┘
 *                         ┌─────┐     ┌─────┐
 *                         │WinLf├─────┤WinRg│
 ...
 * │Sat+ ├─────┤RGB  │Hue+ │down │ ___ │down │left │mouse├─────┤acc1 │
 * ├─────┤RGB  │Mode ├─────┼─────┤/U D\├─────┼─────┤btn3 │mouse├─────┤
 * │RGB  │Lum- ├─────┤RGB  │vol  │|L*R|│RGB  │mouse├─────┤btn2 │mouse│
 * │Sat- ├─────┘     │Hue- │mute │\___/│OnOff│btn1 │     └─────┤acc0 │
 * └─────┘           └─────┴─────┘     └─────┴─────┘           └─────┘
 *                         ┌─────┐     ┌─────┐
 *                         │space├─────┤cmd  │
 *                         │shift│lead │navfn│
...
[_BASE] = LAYOUT(
    ...
    KC_NO,     KC_NO,  KC_NO,           LSFT_T(KC_SPACE),UNICORN,           MC_NAV_CMD,         MC_ENC_SW,   KC_NO,           KC_NO,         KC_NO),
[_NUMSYM] = LAYOUT(
...
[_CMD] = LAYOUT(
    ...
    KC_NO,     KC_NO,  KC_NO,           KC_NO,           KC_NO,             KC_NO,              MC_ENC_SW,        KC_NO,           KC_NO,         KC_NO)
};
