...
/*
 * ┌───────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┬───────┐
 * │c0r0   │c1r0 │c2r0 │c3r0 │c4r0 │c5r0 │c6r0 │c7r0 │c8r0 │c9r0 │c9r3   │
 * │       │     │     │     │     │     │     │     │     │     │       │
 * ├───────┴┬────┴┬────┴┬────┴┬────┴┬────┴┬────┴┬────┴┬────┴┬────┴┐      │
 * │c0r1    │c1r1 │c2r1 │c3r1 │c4r1 │c5r1 │c6r1 │c7r1 │c8r1 │c9r1 │      │
 * │        │     │     │     │     │     │     │     │     │     │      │
 * ├────────┴─┬───┴─┬───┴─┬───┴─┬───┴─┬───┴─┬───┴─┬───┴─┬───┴─┬───┴──────┤
 * │c0r2      │c1r2 │c2r2 │c3r2 │c4r2 │c5r2 │c6r2 │c7r2 │c8r2 │c9r2      │
 * │          │     │     │     │     │     │     │     │     │          │
 * ├─────┬────┴┬────┴┬────┴─────┴┬────┴┬────┴─────┴──┬──┴─────┴──────────┤
 * │c0r3 │c1r3 │c2r3 │c3r3       │c4r3 │c5r3         │                   │
 * │     │     │     │           │     │             │                   │
 * └─────┴─────┴─────┴───────────┴─────┴─────────────┴───────────────────┘
*/
/*
 ...
 * navigation/function
 * ┌───────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┬─────┬───────┐
 * │F1     │F2   │F3   │F4   │F5   │Top  │PgUp │↑    │PgDwn│Bottm│enter  │
 * │       │     │     │     │     │     │     │     │     │     │       │
 * ├───────┴┬────┴┬────┴┬────┴┬────┴┬────┴┬────┴┬────┴┬────┴┬────┴┐      │
 ...
 * │          │     │     │     │     │CtrlV│CtrlV│     │     │          │
 * ├─────┬────┴┬────┴┬────┴─────┴┬────┴┬────┴─────┴──┬──┴─────┴──────────┤
 * │cut  │copy │paste│WinLf      │lead │WinRg        │                   │
 * │     │     │     │           │     │             │                   │
 * └─────┴─────┴─────┴───────────┴─────┴─────────────┴───────────────────┘
 */
/*
...
[_BASE] = LAYOUT(
    ...
    MC_Z,      MC_X,      MC_C,            MC_V,            KC_B,              KC_N,               MC_M,         MMC_COMMA,       MMC_DOT,       MMC_QUOT,
    LCTL(KC_X),LCTL(KC_C),LCTL(KC_V),      LSFT_T(KC_SPACE),UNICORN,           MC_NAV_CMD,         ___,          ___,             ___,           KC_BSPC),
[_NUMSYM] = LAYOUT(
...
[_CMD] = LAYOUT(
    ...
    ___,       ___,       ___,             ___,             ___,               ___,                ___,          ___,             ___,           KC_BSPC),
};
